...
-- === Window rules ===
hl.window_rule({ match = { class = "brave-browser" }, workspace = "6 silent" })

hl.window_rule({
    name = "opacity-terminals",
    match = { class = [[^(kitty|alacritty|Alacritty|com\.mitchellh\.ghostty|org.wezfurlong.wezterm)$]] },
    opacity =
    "0.80 0.70"
})
...
hl.window_rule({
    ...
    match = { class = "^(tuiFileManager|org.kde.dolphin|org.kde.ark|nwg-look|qt5ct|qt6ct)$" },
    opacity =
    "0.80 0.80"
})
hl.window_rule({
...
hl.window_rule({ name = "opacity-spotify", match = { class = "^(Spotify|spotify)$" }, opacity = "0.95 0.90" })
hl.window_rule({
    name = "opacity-apps",
    match = { class = "^(app.drey.Warp|net.davidotek.pupgui2|Signal|io.gitlab.theevilskeleton.Upscaler)$" },
    opacity =
    "0.80 0.80"
})
hl.window_rule({
    name = "opacity-audio-net",
    match = { class = "^(pavucontrol|org.pulseaudio.pavucontrol|blueman-manager|.blueman-manager-wrapped|nm-applet|nm-connection-editor)$" },
    opacity =
    "0.80 0.70"
})
...
hl.window_rule({
    name = "tag-games-class",
    match = { class = [[^(steam_app.*|steam_app_\d+|gamescope|Waydroid|osu!)$]] },
    tag =
    "+games"
})
...
hl.window_rule({ name = "float-spotify", match = { class = "^(Spotify|spotify)$" }, float = true, size = { 1000, 875 }, move = { 10, 55 } })
